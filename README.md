...
[test-image]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2.svg
[dependencies-url]: https://david-dm.org/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/main
...
[cli-section]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2#cli
[cli-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/tree/cli
[@stdlib/assert-has-sharedarraybuffer-support]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/tree/deno
[deno-readme]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/tree/umd
[umd-readme]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/tree/esm
[esm-readme]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.2.2/main/LICENSE
