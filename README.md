...
[test-image]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1.svg
[dependencies-url]: https://david-dm.org/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/main
...
[cli-section]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1#cli
[cli-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/tree/cli
[@stdlib/assert-has-sharedarraybuffer-support]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/tree/deno
[umd-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/tree/umd
[esm-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/tree/esm
[branches-url]: https://github.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/assert-has-sharedarraybuffer-support@v0.1.1/main/LICENSE
